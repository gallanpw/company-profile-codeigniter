...
<div class="container">
    <div class="row"><br><br>
        ...
        <div class="col-lg-4">
            <div class="gambar">
                <a href="<?php echo base_url(); ?>jasa-polyurethane/">
                    <img src="<?php echo base_url(); ?>assets/img/polyurethane/polyurethane-foam.gif" alt="jasa-polyurethane" />
                    <div class="teks">Jasa Produk Polyurethane</div>
                </a>
            </div>
        </div>
    </div>
